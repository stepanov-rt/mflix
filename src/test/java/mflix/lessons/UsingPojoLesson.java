...
public class UsingPojoLesson extends AbstractLesson {
    ...
    public void setUp() throws Exception {
        ...
        Document actorDocument1 = new Document()
                .append("name", "Bruce Campbell")
                .append("date_of_birth", new SimpleDateFormat("yyyy-MM" + "-dd").parse("1958-06-22"))
                .append("awards", Collections.EMPTY_LIST)
                .append("num_movies", 127);

        Document actorDocument2 = new Document()
                .append("name", "Natalie Portman")
                .append("date_of_birth", new SimpleDateFormat("yyyy-MM" + "-dd").parse("1981-06-09"))
                .append("awards", Collections.EMPTY_LIST)
                .append("num_movies", 63);
